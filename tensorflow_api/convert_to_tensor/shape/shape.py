...
print(const6)
tfutil.print_operation_value(tf.shape(const6))

var1 = tf.Variable(1)
tfutil.print_variable(var1)
print(var1)
tfutil.print_operation_value(tf.shape(var1))

var2 = tf.Variable([1, 2])
tfutil.print_variable(var2)
print(var2)
tfutil.print_operation_value(tf.shape(var2))

var3 = tf.Variable([[1, 2], [3, 4]])
tfutil.print_variable(var3)
print(var3)
tfutil.print_operation_value(tf.shape(var3))

var4 = tf.Variable([[1, 2], [3, 4], [5, 6]])
tfutil.print_variable(var4)
print(var4)
tfutil.print_operation_value(tf.shape(var4))

var5 = tf.Variable([[[1], [2]], [[3], [4]]])
tfutil.print_variable(var5)
print(var5)
tfutil.print_operation_value(tf.shape(var5))

var6 = tf.Variable([[[1], [2]], [[3], [4]], [[5], [6]]])
tfutil.print_variable(var6)
print(var6)
tfutil.print_operation_value(tf.shape(var6))
